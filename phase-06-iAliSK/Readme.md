...
در این فاز، قصد داریم شما را با یکی از پایگاه‌داده‌های رابطه‌ای [Relational Database](https://en.wikipedia.org/wiki/Relational_database) به نام [MySQL](https://www.mysql.com/) آشنا کنیم.
...
برای شروع کار عملی با این دیتابیس می‌توانید راهنمای [Creat DB In MySql](../../../backend-ReadMore/blob/master/CreatDbInMySql.md) را مطالعه کنید.

# مطالعات بیشتر
برای کسب دانش بیشتر در مورد SQL می توانید [این بخش](../../../backend-ReadMore/blob/master/AdvancedTopicInMySQL.md) را مطالعه نمایید.
